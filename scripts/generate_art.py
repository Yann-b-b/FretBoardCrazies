#!/usr/bin/env python3
"""Generate FretBoardMastery art assets via the OpenAI Images API.
...
def render_gallery(entries):
    ...
    return (
        "<!doctype html><meta charset=utf-8><title>FretBoardMastery art</title>"
...
def parse_args(argv):
    parser = argparse.ArgumentParser(
        description="Generate FretBoardMastery art assets."
    )
    parser.add_argument(
